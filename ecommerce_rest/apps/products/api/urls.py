...
# from apps.products.api.views.product_views import ProductListAPIView, ProductRetrieveAPIView, ProductDestroyAPIView, ProductUpdateAPIView
...
urlpatterns = [
    ...
    path('detail/<int:pk>/', ProductRetrieveUpdateDestroyAPIView.as_view(), name='detail'),
]
